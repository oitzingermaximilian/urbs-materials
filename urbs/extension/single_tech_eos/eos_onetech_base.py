...
def setup_onetech_learning(m, target_tech_name="solarPV", target_stages=None):
    ...
    if unknown_techs:
        raise ValueError(
            f"Unknown technologies in setup_onetech_learning: {unknown_techs}"
        )
    ...
    if target_stages:
        ...
        if unknown_stages:
            raise ValueError(
                f"Unknown stages in setup_onetech_learning: {unknown_stages}"
            )
...
class OneTech_Capex_CostSavings_Constraint(AbstractConstraint):
    def apply_rule(self, m, stf, location, tech, stage):
        if not check_valid_indices(m, location, tech, stage):
            return pyomo.Constraint.Skip
        val = sum(
            m.P_sec_capex[location, tech, stage, n]
            * m.aux_onetech_capex[stf, location, tech, stage, n]
...
class OneTech_Fom_CostSavings_Constraint(AbstractConstraint):
    def apply_rule(self, m, stf, location, tech, stage):
        if not check_valid_indices(m, location, tech, stage):
            return pyomo.Constraint.Skip
        val = sum(
            m.P_sec_fom[location, tech, stage, n]
            * m.aux_onetech_fom[stf, location, tech, stage, n]
            for n in m.nsteps_sec
        )
...
class OneTech_Capex_PriceReduction_Calc(AbstractConstraint):
    def apply_rule(self, m, stf, location, tech, stage):
        ...
        val = sum(
            m.P_sec_capex[location, tech, stage, n]
            * m.BD_onetech[stf, location, tech, stage, n]
            for n in m.nsteps_sec
        )
...
class OneTech_Capex_Relation_Pnew_Pprior(AbstractConstraint):
    def apply_rule(self, m, stf, location, tech, stage):
        ...
        if stf == 2024:
            return pyomo.Constraint.Skip
        if stf == pyomo.value(m.y0):
            return m.pricereduction_capex_onetech_unit[stf, location, tech, stage] >= 0
        return (
            m.pricereduction_capex_onetech_unit[stf, location, tech, stage]
            >= m.pricereduction_capex_onetech_unit[stf - 1, location, tech, stage]
        )
...
class OneTech_Fom_Relation_Pnew_Pprior(AbstractConstraint):
    def apply_rule(self, m, stf, location, tech, stage):
        ...
        if stf == 2024:
            return pyomo.Constraint.Skip
        if stf == pyomo.value(m.y0):
            return m.pricereduction_fom_onetech_unit[stf, location, tech, stage] >= 0
        return (
            m.pricereduction_fom_onetech_unit[stf, location, tech, stage]
            >= m.pricereduction_fom_onetech_unit[stf - 1, location, tech, stage]
        )
...
def _apply_capex_fom_constraints(m):
    setattr(
        m,
        "c_onetech_invalid_zero_capex",
        pyomo.Constraint(
            m.stf,
            m.location,
            m.tech_one_tech,
            m.stages_one_tech,
            rule=lambda m, t, l, tech, s: OneTech_Capex_InvalidZeroRule().apply_rule(
                m, t, l, tech, s
            ),
        ),
    )
    setattr(
        m,
        "c_onetech_invalid_zero_fom",
        pyomo.Constraint(
            m.stf,
            m.location,
            m.tech_one_tech,
            m.stages_one_tech,
            rule=lambda m, t, l, tech, s: OneTech_Fom_InvalidZeroRule().apply_rule(
                m, t, l, tech, s
            ),
        ),
    )
    ...
    setattr(
        ...
        pyomo.Constraint(
            ...
            l,
            tech,
            s: OneTech_Capex_CostSavings_Constraint().apply_rule(m, t, l, tech, s),
        ),
    )
    setattr(
        m,
        "c_onetech_costsavings_fom",
        pyomo.Constraint(
            m.stf,
            m.location,
            m.tech_one_tech,
            ...
            l,
            tech,
            s: OneTech_Fom_CostSavings_Constraint().apply_rule(m, t, l, tech, s),
        ),
    )

    setattr(
        m,
        "c_onetech_pricered_capex",
        pyomo.Constraint(
            m.stf,
            m.location,
            m.tech_one_tech,
            ...
            l,
            tech,
            s: OneTech_Capex_PriceReduction_Calc().apply_rule(m, t, l, tech, s),
        ),
    )
    setattr(
        m,
        "c_onetech_pricered_fom",
        pyomo.Constraint(
            m.stf,
            m.location,
            m.tech_one_tech,
            m.stages_one_tech,
            rule=lambda m, t, l, tech, s: OneTech_Fom_PriceReduction_Calc().apply_rule(
                m, t, l, tech, s
            ),
        ),
    )
    ...
    setattr(
        ...
        pyomo.Constraint(
            ...
            l,
            tech,
            s: OneTech_Capex_Relation_Pnew_Pprior().apply_rule(m, t, l, tech, s),
        ),
    )
    setattr(
        m,
        "c_onetech_relation_fom",
        pyomo.Constraint(
            m.stf,
            m.location,
            m.tech_one_tech,
            m.stages_one_tech,
            rule=lambda m, t, l, tech, s: OneTech_Fom_Relation_Pnew_Pprior().apply_rule(
                m, t, l, tech, s
            ),
        ),
    )
    ...
    setattr(
        ...
        pyomo.Constraint(
            ...
            m.stages_one_tech,
            m.nsteps_sec,
            rule=lambda m, t, l, tech, s, n: OneTech_Capex_UpperBound_Z().apply_rule(
                m, t, l, tech, s, n
            ),
        ),
    )
    setattr(
        ...
        pyomo.Constraint(
            ...
            m.stages_one_tech,
            m.nsteps_sec,
            rule=lambda m, t, l, tech, s, n: OneTech_Capex_UpperBound_Z_Q1().apply_rule(
                m, t, l, tech, s, n
            ),
        ),
    )
    setattr(
        ...
        pyomo.Constraint(
            ...
            m.stages_one_tech,
            m.nsteps_sec,
            rule=lambda m, t, l, tech, s, n: OneTech_Capex_LowerBound_Z().apply_rule(
                m, t, l, tech, s, n
            ),
        ),
    )
    setattr(
        ...
        pyomo.Constraint(
            ...
            m.stages_one_tech,
            m.nsteps_sec,
            rule=lambda m, t, l, tech, s, n: OneTech_Capex_NonNegativity_Z().apply_rule(
                m, t, l, tech, s, n
            ),
        ),
    )
    ...
    setattr(
        ...
        pyomo.Constraint(
            ...
            m.stages_one_tech,
            m.nsteps_sec,
            rule=lambda m, t, l, tech, s, n: OneTech_Fom_UpperBound_Z().apply_rule(
                m, t, l, tech, s, n
            ),
        ),
    )
    setattr(
        ...
        pyomo.Constraint(
            ...
            m.stages_one_tech,
            m.nsteps_sec,
            rule=lambda m, t, l, tech, s, n: OneTech_Fom_UpperBound_Z_Q1().apply_rule(
                m, t, l, tech, s, n
            ),
        ),
    )
    setattr(
        ...
        pyomo.Constraint(
            ...
            m.stages_one_tech,
            m.nsteps_sec,
            rule=lambda m, t, l, tech, s, n: OneTech_Fom_LowerBound_Z().apply_rule(
                m, t, l, tech, s, n
            ),
        ),
    )
    setattr(
        ...
        pyomo.Constraint(
            ...
            m.stages_one_tech,
            m.nsteps_sec,
            rule=lambda m, t, l, tech, s, n: OneTech_Fom_NonNegativity_Z().apply_rule(
                m, t, l, tech, s, n
            ),
        ),
    )
...
class OneTech_CostSavings_Constraint(AbstractConstraint):
    def apply_rule(self, m, stf, location, tech, stage):
        ...
        return (
            m.PRICEREDUCTION_ONETECH_TOTAL[stf, location, tech, stage]
...
class OneTech_BD_Limitation(AbstractConstraint):
    def apply_rule(self, m, stf, location, tech, stage):
        if not check_valid_indices(m, location, tech, stage):
            return pyomo.Constraint.Skip
        return (
            sum(m.BD_onetech[stf, location, tech, stage, n] for n in m.nsteps_sec) == 1
        )
...
class OneTech_BulkMat_CostSavings_Constraint(AbstractConstraint):
    def apply_rule(self, m, stf, location, tech, stage):
        ...
        if (location, tech, stage, first_step) not in m.P_sec_downstream_manufacturing:
            return (
                m.PRICEREDUCTION_BULKMAT_ONETECH_TOTAL[stf, location, tech, stage] == 0
            )
        ...
        return (
            m.PRICEREDUCTION_BULKMAT_ONETECH_TOTAL[stf, location, tech, stage]
            == reduction_value
        )
...
class OneTech_BulkMat_PriceReduction_Calc(AbstractConstraint):
    def apply_rule(self, m, stf, location, tech, stage):
        ...
        if (location, tech, stage, first_step) not in m.P_sec_downstream_manufacturing:
            return (
                m.pricereduction_bulkmat_onetech_unit[stf, location, tech, stage] == 0
            )
        ...
        return (
            m.pricereduction_bulkmat_onetech_unit[stf, location, tech, stage]
            == unit_val
        )
...
def _apply_constraints(m):
    ...
    setattr(
        m,
        "c_onetech_invalid_zero",
        pyomo.Constraint(
            m.stf,
            m.location,
            m.tech_one_tech,
            m.stages_one_tech,
            rule=lambda m, t, l, tech, s: OneTech_InvalidZeroRule().apply_rule(
                m, t, l, tech, s
            ),
        ),
    )
    ...
    setattr(
        ...
        pyomo.Constraint(
            ...
            m.stages_one_tech,
            m.nsteps_sec,
            rule=lambda m, t, l, tech, s, n: OneTech_InvalidZeroRule_BD().apply_rule(
                m, t, l, tech, s, n
            ),
        ),
    )
    ...
    setattr(
        m,
        "c_onetech_costsavings",
        pyomo.Constraint(
            m.stf,
            m.location,
            m.tech_one_tech,
            m.stages_one_tech,
            rule=lambda m, t, l, tech, s: OneTech_CostSavings_Constraint().apply_rule(
                m, t, l, tech, s
            ),
        ),
    )
    ...
    setattr(
        ...
        pyomo.Constraint(
            ...
            m.tech_one_tech,
            m.stages_one_tech,
            rule=lambda m, t, l, tech, s: OneTech_PriceReduction_Calc().apply_rule(
                m, t, l, tech, s
            ),
        ),
    )
    ...
    setattr(
        ...
        pyomo.Constraint(
            ...
            m.tech_one_tech,
            m.stages_one_tech,
            rule=lambda m, t, l, tech, s: OneTech_BD_Limitation().apply_rule(
                m, t, l, tech, s
            ),
        ),
    )
    ...
    setattr(
        ...
        pyomo.Constraint(
            ...
            m.tech_one_tech,
            m.stages_one_tech,
            rule=lambda m, t, l, tech, s: OneTech_Relation_Pnew_Pprior().apply_rule(
                m, t, l, tech, s
            ),
        ),
    )
    ...
    setattr(
        ...
        pyomo.Constraint(
            ...
            m.tech_one_tech,
            m.stages_one_tech,
            rule=lambda m, t, l, tech, s: OneTech_Q_PerStep().apply_rule(
                m, t, l, tech, s
            ),
        ),
    )
    ...
    setattr(
        ...
        pyomo.Constraint(
            ...
            m.stages_one_tech,
            m.nsteps_sec,
            rule=lambda m, t, l, tech, s, n: OneTech_UpperBound_Z().apply_rule(
                m, t, l, tech, s, n
            ),
        ),
    )
    ...
    setattr(
        ...
        pyomo.Constraint(
            ...
            m.stages_one_tech,
            m.nsteps_sec,
            rule=lambda m, t, l, tech, s, n: OneTech_UpperBound_Z_Q1().apply_rule(
                m, t, l, tech, s, n
            ),
        ),
    )
    ...
    setattr(
        ...
        pyomo.Constraint(
            ...
            m.stages_one_tech,
            m.nsteps_sec,
            rule=lambda m, t, l, tech, s, n: OneTech_LowerBound_Z().apply_rule(
                m, t, l, tech, s, n
            ),
        ),
    )
    ...
    setattr(
        ...
        pyomo.Constraint(
            ...
            m.stages_one_tech,
            m.nsteps_sec,
            rule=lambda m, t, l, tech, s, n: OneTech_NonNegativity_Z().apply_rule(
                m, t, l, tech, s, n
            ),
        ),
    )
...
def _apply_bulkmat_constraints(m):
    ...
    setattr(
        m,
        "c_bulkmat_onetech_invalid_zero",
        pyomo.Constraint(
            m.stf,
            m.location,
            m.tech_one_tech,
            m.stages_one_tech,
            rule=lambda m, t, l, tech, s: OneTech_InvalidZeroRule_BulkMat().apply_rule(
                m, t, l, tech, s
            ),
        ),
    )
    ...
    setattr(
        ...
        pyomo.Constraint(
            ...
            l,
            tech,
            s: OneTech_BulkMat_CostSavings_Constraint().apply_rule(m, t, l, tech, s),
        ),
    )

    setattr(
        m,
        "c_bulkmat_onetech_pricered",
        pyomo.Constraint(
            m.stf,
            m.location,
            m.tech_one_tech,
            ...
            l,
            tech,
            s: OneTech_BulkMat_PriceReduction_Calc().apply_rule(m, t, l, tech, s),
        ),
    )

    setattr(
        m,
        "c_bulkmat_onetech_relation",
        pyomo.Constraint(
            m.stf,
            m.location,
            m.tech_one_tech,
            ...
            l,
            tech,
            s: OneTech_BulkMat_Relation_Pnew_Pprior().apply_rule(m, t, l, tech, s),
        ),
    )
