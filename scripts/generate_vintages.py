...
def generate_vintages_from_data(input_file, output_file, vintage_years):
    ...
    for sheet_name in xls.sheet_names:
        ...
        if sheet_name == "Process":
            ...
            for tech in unique_techs:
                ...
                for year in all_years:
                    ...
                    if not actual_year_data.empty:
                        ...
                        tech_2024_data = df[
                            (df["Year"] == base_year) & (df["Process"] == tech)
                        ]
            ...
            print(
                f"Processing the '{sheet_name}' sheet for vintages based on true data..."
            )
            df_new = []
            ...
            print(
                f"Processing the '{sheet_name}' sheet, duplicating 2024 data across all years..."
            )
            df_new = []
...
if __name__ == "__main__":
    ...
    output_file = os.path.join(
        BASE_DIR, "Input", "urbs_intertemporal_master_vintages.xlsx"
    )
